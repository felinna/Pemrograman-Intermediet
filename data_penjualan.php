...
<body>
    ...
    <a href="penjualan.php"><button type="submit" class="btn btn-success mt-3 mb-3">Tambah</button></a>
    <a href="print.php" target="_blank"><button type="submit" class="btn btn-primary mt-3 mb-3 ">Cetak Data</button></a>
        ...
        <div class="card shadow-sm my-0">
            <div class="navbar navbar-lg text-white bg-info ">
	            <a class="navbar-brand"><h5>Transaksi Penjualan</h5></a>
	        </div >
            <table border="1">
                <thead>
                    <tr align="center">
                    ...
                    <tbody>
                        <?php 
                        $result =$model->tampil_datapenjualan();
                        if (!empty($result)){
                            ...
                            <tr>
                                ...
                                <td collspan="1" align="center">
                                    <a name="edit" id="edit" href="edit_penjualan.php?kode_produk=<?= $data->kode_produk ?>">
                                        <button type="submit" name="submit_penjualan" class="btn btn-primary mt=6s">Edit</button>
                                    </a>
