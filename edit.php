...
<div class="container mt-4 mb-4">
    <div class="card shadow-sm my-0">
        <div class="navbar navbar-lg text-white bg-info mb-3">
	        <a class="navbar-brand"><h5>Edit Produk</h5></a>
	    </div >
        <div class="col-md-6">
            ...
            <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="double" name="harga" class="form-control"  aria-describedby="harga" value="<?php echo $data->harga ?>"/>
                </div> 

                <div class="mb-3">
                    <label for="stok" class="form-label">Stok</label>
                    <input type="int" name="stok" class="form-control"  aria-describedby="stok" value="<?php echo $data->stok ?>"/>
                </div> 
                    
                <button type="submit" name="submit_edit" class="btn btn-primary mt-3 mb-3">Update</button>
                <a href="index.php"><button type="submit" class="btn btn-primary mt-3 mb-3 ">Back</button></a>
                <br><br>
            </div>
