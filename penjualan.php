            ...
            <form action="proces.php?add" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="jumlah" class="form-control"  aria-describedby="jumlah" />
                    </div> 

                    <button type="submit" name="submit_penjualan" class="btn btn-primary mt-3 mb-3">Save</button>
